...
from tt.utils.net_utils import to_device
from tt.transducer.blocks import build_blocks
from tt.transducer.joint_network import JointNetwork
from tt.transducer.utils import check_state
from tt.transducer.utils import pad_batch_state
from tt.transducer.utils import pad_sequence
from tt.transformer.layer_norm import LayerNorm
from tt.transformer.mask import subsequent_mask
from tt.interface.transducer_decoder_interface import TransducerDecoderInterface


class TDecoder(TransducerDecoderInterface, torch.nn.Module):
